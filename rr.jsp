...
.bg {
    /* The image used */
    background-image: url(http://localhost:8082/IPL/images/rr.jpg);
...
try
{
	...
	String query1="select home_ground,captain,coach from team where id=6;";
	...
	<%
	String query2="select name,role,bats,bowls,dob from player where role='Batsman' and team_id=6;";
...
<%
	String query3="select name,role,bats,bowls,dob from player where role='Bowler'and team_id=6;";
...
<%
	String query4="select name,role,bats,bowls,dob from player where role='Allrounder' and team_id=6;";
