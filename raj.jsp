...
.bg {
    /* The image used */
    background-image: url(http://localhost:8082/IPL/images/raj.jpg);
...
try
{
	...
	String q1="select p.name from player p , auction a where p.p_id=a.p_id and a.retained='Yes' and p.team_id= 6;";
...
%> 
	...
	<%
	String q2="select p.name,a.bid_amount from player p,auction a where p.p_id=a.p_id and p.team_id=6 and a.bid_amount > 0  order by a.bid_amount DESC;";
