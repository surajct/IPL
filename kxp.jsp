...
.bg {
    /* The image used */
    background-image: url(http://localhost:8082/IPL/images/kxp.jpg);
...
<div class="navbar">
  ...
  </div>  <a href="table.jsp">PointsTable</a>
  <div class="dropdown">
...
try
{
	...
	String query1="select home_ground,captain,coach from team where id=8;";
	...
	<%
	String query2="select name,role,bats,bowls,dob from player where role='Batsman' and team_id=8;";
...
<%
	String query3="select name,role,bats,bowls,dob from player where role='Bowler'and team_id=8;";
...
<%
	String query4="select name,role,bats,bowls,dob from player where role='Allrounder' and team_id=8;";
